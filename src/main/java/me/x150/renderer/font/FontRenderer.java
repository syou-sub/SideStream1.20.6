...
public class FontRenderer implements Closeable
{
	 ...
	 *
	 * @param fonts
	 *            The fonts to use. The font renderer will go over each font in
	 *            this array, search for the glyph, and render it if found. If
	 *            no font has the specified glyph, it will draw the missing font
	 *            symbol.
	 * @param sizePx
	 *            The size of the font in minecraft pixel units. One pixel unit
	 *            = `guiScale` pixels
	 */
	...
	private Glyph locateGlyph0(char glyph)
	{
		...
		{ // go over existing ones
			if(map.contains(glyph))
			{ // do they have it? good
	 ...
	 * @param r
	 *            Red color component of the text to draw
	 * @param g
	 *            Green color component of the text to draw
	 * @param b
	 *            Blue color component of the text to draw
	 * @param a
	 *            Alpha color component of the text to draw
	 */
		...
		float r, float g, float b, float a)
	{
		...
		for(int i = 0; i < chars.length; i++)
		{
			...
			if(glyph.value() != ' ')
			{ // we only need to really draw the glyph if it's not blank,
	 ...
	 *            The string to draw
	 * @param x
	 *            X center coordinate of the text to draw
	 * @param y
	 *            Y coordinate of the text to draw
	 * @param r
	 *            Red color component
	 * @param g
