...
public class MSAAFramebuffer extends Framebuffer
{
	 ...
	 *
	 * @param samples
	 *            The desired amount of samples to be used. While everything up
	 *            to (and including) MAX_SAMPLES is accepted, anything above 16
	 *            is generally overkill.
	 * @param drawAction
	 *            The runnable that gets executed within the framebuffer. Render
	 *            your things there.
	 */
	 ...
	 *
	 * @param samples
	 *            The desired amount of samples to be used
	 * @param mainBuffer
	 *            The main framebuffer to read and write to once the buffer
	 *            finishes
	 * @param drawAction
	 *            The runnable that gets executed within the framebuffer. Render
	 *            your things there.
