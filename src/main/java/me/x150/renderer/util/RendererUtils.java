...
public class RendererUtils
{
	 ...
	 *
	 * @param stack
	 *            The MatrixStack to translate with
	 * @param in
	 *            The Vec3d to translate
	 ...
	 *
	 * @param i
	 *            The identifier to register the texture under
	 * @param bi
	 *            The BufferedImage holding the texture
	 */
	 ...
	 *
	 * @param pos
	 *            The world space coordinates to translate
	 ...
	 *
	 * @param pos
	 *            The (x, y, d) coordinates to check
