...
/*    */   public void load() {
/*    */     try {
/* 25 */       BufferedReader var6 = new BufferedReader(new FileReader(getFile()));
/*    */       String line;
/* 27 */       while ((line = var6.readLine()) != null) {
/* 28 */         String[] arguments = line.split(":");
/* 29 */         if (arguments.length == 3) {
/* 30 */           Module mod = ModuleManager.getModulebyLowerName(arguments[0]);
/* 31 */           if (mod != null) {
/* 32 */             mod.setEnable(Boolean.parseBoolean(arguments[1]));
...
/*    */   public void save() {
/*    */     try {
/* 47 */       BufferedWriter var4 = new BufferedWriter(new FileWriter(getFile()));
/* 48 */       Iterator<Module> var3 = ModuleManager.modules.iterator();
/* 49 */       while (var3.hasNext()) {
/* 50 */         Module mod = var3.next();
/* 51 */         String text = String.valueOf(mod.getName().toLowerCase()) + ":" + mod.isEnable()+ ":" + mod.getKeyCode();
/* 52 */         var4.write(text);
/* 53 */         var4.newLine();
/*    */       } 
/* 55 */       var4.close();
...
/* Location:              C:\Users\Null\Downloads\Qurobito LEAK\Qurobito.jar!\client\config\configs\ModuleConfig.class
